...
echo "- Web/SigePol CT110: 2.5 GiB inicial"
echo "- Database CT111: 2 GiB inicial"
echo "- Backup CT112: 0.5 GiB; dados na unidade USB de 1 TB"
echo "- Monitoring CT113: 0.5 GiB"
echo "- VPN CT114: 0.375 GiB"
echo "- Home Assistant: fora deste host"
echo "- Grom_Security/Frigate VM130: 4 GiB inicial; sem gravacao continua"
