...
plan_step "Executar deploy-all.sh somente depois de GO explicito."
plan_step "Executar post-deploy-validation.sh com e sem --public-target."
plan_step "Executar restore-drill.sh, operational-health-check.sh e production-readiness-check.sh."
